...
---------------------------------------------------------
GO
/****** Object:  StoredProcedure [dbo].[GetProjectChildhoodCancerStatsBySearchID]    Script Date: 7/11/2025 1:11:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ALTER PROCEDURE [dbo].[GetProjectAwardStatsBySearchID]   
    @SearchID INT,
	@Year INT,	
	@Type varchar(25) = 'Count',  -- 'Count' or 'Amount'	
