  ...
  */
  public static function getAnalytics(PDO $pdo, array $parameters, int $limit = 50): array {
    ...
    $queries = [
      ...
      'project_counts_by_cso_research_area' => $use_base_query
        ? 'EXECUTE GetProjectCSOStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectCSOStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      'project_counts_by_cancer_type' => $use_base_query
        ? 'EXECUTE GetProjectCancerTypeStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectCancerTypeStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      'project_counts_by_type' => $use_base_query
        ? 'EXECUTE GetProjectTypeStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectTypeStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      'project_counts_by_year' => $use_base_query
        ? 'EXECUTE GetProjectAwardStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectAwardStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      'project_counts_by_institution' => $use_base_query
        ? 'EXECUTE GetProjectInstitutionStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectInstitutionStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      'project_counts_by_childhood_cancer' => $use_base_query
        ? 'EXECUTE GetProjectChildhoodCancerStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectChildhoodCancerStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      'project_counts_by_funding_organization' => $use_base_query
        ? 'EXECUTE GetProjectFundingOrgStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count'
        : 'EXECUTE GetProjectFundingOrgStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Count',

      // Amount queries
      'project_funding_amounts_by_country' => $use_base_query
        ? 'EXECUTE GetProjectCountryStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectCountryStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_cso_research_area' => $use_base_query
        ? 'EXECUTE GetProjectCSOStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectCSOStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_cancer_type' => $use_base_query
        ? 'EXECUTE GetProjectCancerTypeStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectCancerTypeStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_type' => $use_base_query
        ? 'EXECUTE GetProjectTypeStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectTypeStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_year' => $use_base_query
        ? 'EXECUTE GetProjectAwardStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectAwardStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_institution' => $use_base_query
        ? 'EXECUTE GetProjectInstitutionStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectInstitutionStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_childhood_cancer' => $use_base_query
        ? 'EXECUTE GetProjectChildhoodCancerStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectChildhoodCancerStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',

      'project_funding_amounts_by_funding_organization' => $use_base_query
        ? 'EXECUTE GetProjectFundingOrgStatsBySearchID @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount'
        : 'EXECUTE GetProjectFundingOrgStatsBySearchIDBase @SearchID = :search_id, @Year = :year, @ResultCount = :results_count, @ResultAmount = :results_amount, @Type = Amount',
    ];
  ...
  public static function getSearchResults(PDO $pdo, array $parameters): array {
    ...
    $query_string = '
      EXECUTE GetProjectsByCriteria
        ...
        @ChildhoodCancerList  = :is_childhood_cancer,
