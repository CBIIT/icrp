...
/**
 * @file
 * Contains \Drupal\partnership_import\Form\UserImportForm.
 */

namespace Drupal\partnership_import\Form;
...
use Drupal\partnership_import\Controller\PartnershipImportController;

class PartnershipImportForm extends FormBase {

  /**
   * Implements \Drupal\Core\Form\FormInterface::getFormID().
   */
  public function getFormID() {
    return 'partnership_import_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    */
    ...
    $form['actions']['submit'] = array(
      '#type' => 'submit',
      '#value' => $this->t('Import Partnerhsip Applications'),
      '#button_type' => 'primary',
    );
