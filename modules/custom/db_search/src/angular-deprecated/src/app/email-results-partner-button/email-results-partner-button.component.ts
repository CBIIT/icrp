...
@Component({
  ...
  templateUrl: './email-results-partner-button.component.html',
  styleUrls: ['./email-results-partner-button.component.css']
})
export class EmailResultsPartnerButtonComponent implements OnInit {
