...
//    this.loggedIn = true;
  ...
  setInitialPartnerSearchParameters(partners, funding_years, index) {
    ...
    this.initialParameters = {
      years: funding_years.map(y => +y),
      funding_organizations: parsed_partners
    }

    console.log('updated partner search parameters', this.initialParameters);
  }
