...
@Component({
  ...
  templateUrl: './export-results-single-partner-button.html',
  styleUrls: ['./export-results-single-partner-button.css']
})
export class ExportResultsSinglePartnerButton implements OnInit {
  ...
  downloadResult(modal: any){
  	...
  	let endpoint = '/load/ExportResultsSignlePartner';
