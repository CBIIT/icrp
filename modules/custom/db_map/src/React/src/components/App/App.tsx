...
import { BASE_URL, getLocations, getExcelExport, getNewSearchId, Location, ExcelSheet, MapLevelInterface } from '../../services/DataService';
...
export default class App extends React.Component<{}, AppState> {
  ...
  async componentDidMount() {
    ...
    let data = await getLocations(searchId);
          ...
          >
            <div className="display-flex align-items-center">
              <svg width="12px" height="12px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <g id="desktop-download" stroke="none" strokeWidth="1" fillRule="evenodd" fill="#000000">
