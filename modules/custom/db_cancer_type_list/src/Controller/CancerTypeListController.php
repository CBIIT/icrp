...
class CancerTypeListController extends ControllerBase {
  ...
  */
  ...
  public function getCancerTypes() {
    ...
    $stmt = $pdo->prepare('SET NOCOUNT ON; SELECT Name as label, SiteURL as url, Description as description, ICRPCode as icrp_code, ICD10CodeInfo as icd10_code FROM CancerType ORDER BY SortOrder, Name');
    $results = [];
