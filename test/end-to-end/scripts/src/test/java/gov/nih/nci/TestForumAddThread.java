...
/////// Forum - Add Thread ///////////////
	...
	public void ICRP_Forum_Add_A_New_Thread_With_An_Image() throws Exception{
		...
		try{
			...
			Test.clickLink(By.xpath("/html/body/div[1]/div/div/section/div[2]/div[3]/div/div/form/div[7]/button"));
	...
	public void ICRP_Forum_Add_A_New_Thread_With_Links() throws Exception{
		...
		try{
			...
			Test.clickLink(By.xpath("/html/body/div[4]/div[2]/div/form/div[2]/button"));
