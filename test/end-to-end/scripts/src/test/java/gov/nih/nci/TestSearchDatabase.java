	...
	/////// Search Database ///////////////		
		...
		public void ICRP_Search_Database_Partner() throws Exception{
			...
			try{
				...
				Test.clickLink(By.cssSelector(".ng-tns-c10-2 > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)"));
				...
				Test.wait_For(5000);
				Test.clickLink(By.cssSelector(".ng-tns-c10-3 > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)"));
